...
*/
     ...
     * See below for why.
     */
    public static void writeObjectToFile(GcsFilename fileName, GcsFileOptions options, Object content) throws IOException {
     ...
     */
    public static void writeToFile(GcsFilename fileName, GcsFileOptions options, byte[] content) throws IOException {
        @SuppressWarnings("resource")
        GcsOutputChannel outputChannel =
                gcsService.createOrReplace(fileName, options);
     ...
     */
    public static Object readObjectFromFile(GcsFilename fileName)
     ...
     */
    public static byte[] readFromFile(GcsFilename fileName) throws IOException {
    ...
    public static boolean deleteFile(GcsFilename fileName) throws IOException, ClassNotFoundException {
